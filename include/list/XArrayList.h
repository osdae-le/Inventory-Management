    ...
    int capacity)
{
    ...
    cout << "done XArrayList<T>::XArrayList \n";
}
...
void XArrayList<T>::copyFrom(const XArrayList<T> &list)
{
    ...
    this->data = new T[this->capacity]; // try catch ìf not enough memory
    ...
    cout << "done XArrayList<T>::copyFrom \n";
}
...
void XArrayList<T>::removeInternalData()
{
    ...
    this->count = 0;
    this->capacity = 0;
    cout << "done XArrayList<T>::removeInternalData \n";
}
...
XArrayList<T>::XArrayList(const XArrayList<T> &list)
{
    // TODO
    this->copyFrom(list);
    cout << "done XArrayList<T>::XArrayList(const XArrayList<T> &list)\n";
}
...
{
    // TODO
    cout << "Adding element at index: " << count << endl;
    ensureCapacity(count + 1);

    data[count] = e;
    count++;
    cout << "done XArrayList<T>::add(T e)\n";
}
...
void XArrayList<T>::add(int index, T e)
{
    ...
    data[index] = e;
    count++;
    cout << "done XArrayList<T>::add(int index, T e)\n";
}
...
T XArrayList<T>::removeAt(int index)
{
    ...
    count--;
    return removedItem;
    cout << "done XArrayList<T>::removeAt(int index)\n";
}
...
bool XArrayList<T>::removeItem(T item, void (*removeItemData)(T))
{
    ...
    removeAt(index);
    cout << "done XArrayList<T>::removeItem(T item, void (*removeItemData)(T))\n";
    return true;
}
...
int XArrayList<T>::indexOf(T item)
{
    ...
    {
        cout << "Comparing item at index " << i << endl;
...
void XArrayList<T>::ensureCapacity(int index)
{
    ...
    if (index >= capacity)
    {
        ...
        delete[] data;
        cout << "Deleted old data, capacity updated to: " << newCapacity << endl;
        // Cập nhật con trỏ và capacity
        data = newData;
        capacity = newCapacity;
    }
    cout << "done ensureCapacity()\n";
}
